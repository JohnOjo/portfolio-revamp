      ...
      <div className={"about-me-container"}>
        <div className={"about-me-bio"}>
          ...
          <div className={"contact-icons-container"}>
            ...
            <a
              href={
                "https://github.com/JohnOjo/Portfolio/blob/main/src/assets/John%20Ojo%20-%20CV.pdf"
              }
              target={"_blank"}
              rel={"noopener noreferrer"}
            >
