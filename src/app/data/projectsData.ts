...
export const favouriteProjects: Project[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "Tech: React, Node.js, Express.js, SendGrid, Github Pages, Github Actions, Heroku",
...
export const otherProjects: Project[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "Tech: Angular 9, Node.js, Express.js, MongoDB, Mongoose, Jenkins, Redis",
      "Worked in a team environment.",
    ],
  ...
  },
  {
    ...
    body: [
      ...
      "Tech: Angular 9, Node.js, Express.js, Postgresql, Sequelize, AWS S3",
      "Worked in a team environment.",
    ],
  ...
  },
  {
    ...
    body: [
      ...
      "Tech: Angular 11, Node.js, Express.js, Postgresql, Sequelize, MongoDB, Mongoose, CubeJs",
      "Worked in a team environment.",
    ],
  ...
  },
  {
    ...
    body: [
      ...
      "Tech: Angular 9, Node.js, Express.js, MongoDB, Mongoose, AWS S3",
      "Worked in a team environment.",
    ],
    chips: ["Angular", "Node.js", "MongoDB", "AWS"],
    technologiesUsedImages: [Angular, NodeJs, MongoDB, AmazonWebServices],
